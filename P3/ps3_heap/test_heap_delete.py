...
class TestHeap(unittest.TestCase):
    ...
    def timed_heapsort_test(self, test_name, array):
        ...
        end_time = time.time()
        print('Time for test', test_name + ':', end_time - start_time,
              'seconds')
    ...
    def test4(self):
        ...
        self.timed_heapsort_test(
            '1k', [(219 * (i**2) + 53 * i + 15) % 10000 for i in range(1000)])

    def test5(self):
        "Heapsort on 10k elements"
        self.timed_heapsort_test('10k', [(257 * (i**2) + 19 * i + 66) % 100000
                                         for i in range(10000)])

    def test6(self):
        "Heapsort on 100k elements"
        self.timed_heapsort_test(
            '100k', [(92 * (i**3) + 165 * (i**2) + 29 * i + 83) % 1000000
